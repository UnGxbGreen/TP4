        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    flm_titre = table.Column<string>(type: "text", nullable: true),
                    ...
                    flm_genre = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    utl_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    utl_nom = table.Column<string>(type: "text", nullable: true),
                    utl_prenom = table.Column<string>(type: "text", nullable: true),
                    utl_mobile = table.Column<string>(type: "char(10)", nullable: true),
                    utl_mail = table.Column<string>(type: "text", nullable: true),
                    utl_pwd = table.Column<string>(type: "text", nullable: true),
                    utl_rue = table.Column<string>(type: "text", nullable: true),
                    utl_cp = table.Column<string>(type: "char(5)", nullable: true),
                    utl_ville = table.Column<string>(type: "text", nullable: true),
                    utl_pays = table.Column<string>(type: "text", nullable: true, defaultValue: "France"),
